...
export const DURATION_BANDS: HeatmapBand[] = [
  ...
  { label: 'Moderate (30–60 min)',    min: 1800, max: 3600,     color: UI_COLORS.accent },
...
export const TRAINING_LOAD_BANDS: HeatmapBand[] = [
  ...
  { label: 'Easy–moderate (50–100)',          min: 50,  max: 100,      color: UI_COLORS.accent },
  { label: 'Moderate–hard (100–200)',         min: 100, max: 200,      color: '#ff8c00' },
  { label: 'Very hard / big stress (200+)',   min: 200, max: Infinity,  color: '#e63419' },
];

export const TRAINING_EFFECT_BANDS: HeatmapBand[] = [
  { label: 'Recovery',                  min: 0, max: 0, color: STATUS_COLORS.productive },
  { label: 'Base (Low Aerobic)',        min: 0, max: 0, color: STATUS_COLORS.productive },
